...
namespace Kurs_pr_Bayer_A_A
{
    public class S_List
    {
        ...
        public static S_List GetRandomUnorderedList(int size)
        {
            S_List tmp = new S_List();
        ...
        public static S_List GetRandomOrderedList(int size)
        {
            S_List tmp = new S_List();
            Random rnd = new Random();
            int last = 0;
        ...
        public static S_List GetRandomOrderedInReverseOrderList(int size)
        {
            S_List tmp = S_List.GetRandomOrderedList(size);
        ...
        public static S_List GetRandomPartlyOrderedList(int size, int PercentOfOrder)
        {
            S_List tmp = new S_List();
            Random rnd = new Random();
            int last = 0;
